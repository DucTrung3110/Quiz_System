...
class Quiz {
    ...
    public function createQuiz($title, $description, $time_limit = null) {
        $sql = "INSERT INTO quizzes (title, description, time_limit, created_at) VALUES (?, ?, ?, datetime('now'))";
    ...
    public function updateQuiz($id, $title, $description, $time_limit = null) {
        $sql = "UPDATE quizzes SET title = ?, description = ?, time_limit = ?, updated_at = datetime('now') WHERE id = ?";
    ...
    public function deleteQuiz($id) {
        $sql = "UPDATE quizzes SET status = 'deleted', updated_at = datetime('now') WHERE id = ?";
