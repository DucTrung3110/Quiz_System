...
class User {
    ...
    public function register($username, $email, $password, $fullName) {
        ...
        // Insert new user
        $sql = "INSERT INTO users (username, email, password, full_name, created_at) VALUES (?, ?, ?, ?, datetime('now'))";
    ...
    public function updateProfile($id, $email, $fullName) {
        $sql = "UPDATE users SET email = ?, full_name = ?, updated_at = datetime('now') WHERE id = ?";
